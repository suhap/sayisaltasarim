...
Mikro işlemcilerin keşfi, cep telefonu ve internet gibi günlük hayatımızı kökten değiştiren teknolojileri ortaya çıkamasına imkan tanımıştır. Mikroişlemcilerin inanılmaz hızlı gelişmi sayesinde ise günümüzde kullanılan sıradan bir akıllı telefon otuz yıl önceki bir sunucudan çok daha fazla yeteneğe sahiptir. Bu gelişmeler ise bir çok alanda (tıp, askeriye vb.) mevcut cihazlar evrim geçirirken yeni bir çok cihazda hizmet vermeye başlamıştır. Gelişmiş ve yeni cihazlar ise kullanıldıkları alanda köklü değişikliklere gidilmesini sağlamıştır. Örneğin insansız hava araçlarının ortaya çıkması ordularını savaşma şekilini ve stratejilerini önemli ölçüde değiştirmiştir. Günlük yaşantımıza bu kadar etkisin olan bu teknolojinin elbetteki önemli bir ekonomik değeride mevcuttur. Dünya çapında 83 milyon dolar olan mikroişlemci satışlarının 2030 yılında 128 milyon dolarak çıkması beklenmektedir. Ancak mikroişlemci teknolojisini yanlızca teknik, ekonomik ve sosyal olarak vurgulamakla birlikte, mikroişlemici mimarisinin en karmaşık insan icatlarından biri olduğunu kabul etmemiz .

Bu kitabı okumayı bitirdiğinizde, kendi mikroişlemcinizi nasıl tasarlayıp oluşturacağınızı öğreneceksiniz. Yol boyunca öğrendiğiniz beceriler, sizi diğer birçok dijital sistemi tasarlamaya hazırlayacaktır.
